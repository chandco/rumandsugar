...
function chandco_enqueue_scripts() {
	...
	wp_enqueue_script( 'magnific-popup', get_stylesheet_directory_uri() . "/js/magnific-popup.js",  array( 'jquery'), '0.9.9', true );
	wp_enqueue_script( 'chandco-main', get_stylesheet_directory_uri() . "/js/main.js", array( 'jquery', 'magnific-popup'), '1', true );
}
